...
internal class CodeGenerator(override val context: Context) : ContextUtils {
    ...
    fun indirectBr(address: LLVMValueRef, bbLabel: Collection<LLVMBasicBlockRef>): LLVMValueRef? {
        val indirectBr = LLVMBuildIndirectBr(builder, address, bbLabel.size)
        bbLabel.forEach { LLVMAddDestination(indirectBr, it) }
        return indirectBr
    }
